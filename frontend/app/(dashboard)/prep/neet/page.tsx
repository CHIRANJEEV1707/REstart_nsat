...
export default function NEETPage() {
  ...
  const headerProps = examDetails ? {
    ...
    subtext: examDetails.description || "Medical Entrance | India",
    ...
    eligibleColleges: "AIIMS, JIPMER, Govt Medical Colleges",
  } : {
    examName: "NEET UG 2026",
    subtext: "Medical Entrance | India",
    deadlineDate: "2026-03-09",
    nextAttempt: "May 2026",
    eligibleColleges: "AIIMS, JIPMER, GMCs"
  };
