...
export default function UGEEPage() {
  const [examDetails, setExamDetails] = useState<ExamDetails | null>(null);
  const [isCollegeModalOpen, setIsCollegeModalOpen] = useState(false);
  const EXAM_SLUG = 'ugee';
  ...
  const headerProps = examDetails ? {
    ...
    subtext: examDetails.description || "Research Dual Degree | IIIT Hyderabad",
    ...
    eligibleColleges: "IIIT Hyderabad",
  } : {
    examName: "UGEE 2026",
    subtext: "Research Dual Degree | IIIT Hyderabad",
