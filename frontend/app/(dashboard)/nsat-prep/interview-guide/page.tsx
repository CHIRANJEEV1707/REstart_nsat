                ...
                {isLoading ? (
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                        {guidesList.map(guide => (
                            <div key={guide._id} className="bg-white rounded-xl border border-gray-100 p-6 hover:shadow-lg hover:border-purple-200 transition-all group relative overflow-hidden">
                                {guide.isFree && (
