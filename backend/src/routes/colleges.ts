...
import { getColleges, getCollege, getNewGenColleges, getInternationalColleges, getNewGenCollege, getInternationalCollege, getCollegeRank } from '../controllers/collegeController';
