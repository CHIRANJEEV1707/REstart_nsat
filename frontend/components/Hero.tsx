                ...
                <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
                    <div className="flex-1 text-center lg:text-left">
                        <h1 className="text-5xl lg:text-7xl font-bold tracking-tight text-gray-900 leading-[1.1] mb-6">
                            Find the Right <span className="text-indigo-600">Engineering College</span> — Without the Chaos.
                        </h1>
                        ...
                        <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4">
                            <Link
                                href="/explore"
                                className="w-full sm:w-auto px-8 py-4 bg-indigo-600 text-white rounded-xl font-bold text-lg shadow-lg hover:shadow-xl hover:bg-indigo-700 transition-all transform hover:-translate-y-1"
                            >
                                Start Exploring
                            </Link>
                            <Link
                    ...
                    <div className="flex-1 relative w-full max-w-lg lg:max-w-none">
                        ...
                        <div className="relative aspect-square rounded-3xl bg-gradient-to-tr from-indigo-100 to-blue-50 border border-indigo-50 p-8 shadow-2xl rotate-3 hover:rotate-0 transition-all duration-500">
                            ...
                            <div className="grid grid-cols-2 gap-4 h-full">
                                <div className="bg-white rounded-2xl shadow-sm p-4 flex flex-col justify-between animate-pulse-slow">
                                    <div className="h-2 w-12 bg-indigo-100 rounded-full"></div>
                                ...
                                <div className="bg-indigo-600 rounded-2xl shadow-xl p-4 flex flex-col justify-end translate-y-8">
                                ...
                                <div className="bg-blue-50 rounded-2xl p-4 col-span-2 mt-4 flex items-center justify-between border border-blue-100">
                                    <div className="flex -space-x-2">
                                        {[1, 2, 3].map(i => (
                                            <div key={i} className="w-8 h-8 rounded-full bg-indigo-200 border-2 border-white"></div>
                                        ))}
                                    </div>
                                    <div className="text-indigo-800 font-semibold text-sm">Join 10k+ Students</div>
                                </div>
                            </div>
                        </div>
                    </div>
